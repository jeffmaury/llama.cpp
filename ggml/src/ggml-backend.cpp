// Note: porting the code in this file to C++ is a work in progress
...
void ggml_backend_reg_add_device(ggml_backend_reg_t reg, const char * params) {
    reg->iface.add_device(reg, params);
}
...
/*
    ...
    extern int ggml_backend_vk_reg_devices(void);
    ggml_backend_vk_reg_devices();
#endif

#ifdef GGML_USE_KOMPUTE
    extern void ggml_backend_kompute_reg_devices(void);
    ggml_backend_kompute_reg_devices();
#endif

#ifdef GGML_USE_CANN
    extern int ggml_backend_cann_reg_devices(void);
